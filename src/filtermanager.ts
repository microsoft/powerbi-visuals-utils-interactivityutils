...
export class FilterManager {
    ...
    */
    public static restoreSelectionIds(filter: AppliedFilter): ISelectionId[] {
        ...
        try {
            if (filter
                ...
                filter.whereItems.forEach( whereItem => {
                    ...
                    let selectionId: ISelectionId[] = condition.values.map((valueArray: any[]) => {
                        ...
                        const identity: powerbi.DataViewScopeIdentity = powerbi["data"].createDataViewScopeIdentity(sqlExpr);
